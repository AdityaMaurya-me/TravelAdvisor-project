    ...
    <section className="relative overflow-hidden">
      <PageContainer>
        <div className="relative min-h-168 overflow-hidden md:min-h-176 xl:min-h-184">
          ...
          <div className="pointer-events-none absolute inset-0 bg-linear-to-r from-[#06111d]/95 via-[#06111d]/72 to-[#06111d]/20" />
          {/* <div className="pointer-events-none absolute inset-0 bg-linear-to-t from-[#06111d]/65 via-transparent to-transparent" /> */}
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_top,#07111e_0%,rgba(7,17,30,.97)_10%,rgba(7,17,30,.76)_25%,rgba(7,17,30,.28)_43%,transparent_58%)]" />
