...
import { Flag, RefreshCw, ShieldAlert, Trash2 } from "lucide-react";
...
export function ModerationDashboard() {
  ...
  const load = async () => {
    ...
    setTipReports((tips ?? []) as unknown as ReportedTip[]);
    setCommentReports((comments ?? []) as unknown as ReportedComment[]);
  };
