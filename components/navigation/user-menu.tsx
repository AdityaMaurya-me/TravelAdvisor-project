...
export function UserMenu() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (!user) { setName("Traveller"); setAvatar(""); setIsAdmin(false); return; }
